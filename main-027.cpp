...
int main(int argc, char** argv) {
	...
	base = imread("//home//fang//下载//opencv基础代码和ppt//test.jpg");
	if (!base.data) {
		printf("could not load image...\n");
		return -1;
	}
	test1 = imread("//home//fang//下载//opencv基础代码和ppt//filter2d_2.jpg");
	test2 = imread("//home//fang//下载//opencv基础代码和ppt//mask_3.jpg");
	...
	// hue varies from 0 to 179, saturation from 0 to 255   filter2d_2.jpg   mask_3.jpg
	float h_ranges[] = { 0, 180 };     
	float s_ranges[] = { 0, 256 };
	const float* ranges[] = { h_ranges, s_ranges };//值域范围
    ...
    char outfile[100];
    sprintf(outfile, "//home//fang//下载//opencv基础代码和ppt//compareHist_27(1).jpg");
    imwrite(outfile, test1);

    sprintf(outfile, "//home//fang//下载//opencv基础代码和ppt//compareHist_27(2).jpg");
    imwrite(outfile, test2);

    sprintf(outfile, "//home//fang//下载//opencv基础代码和ppt//compareHist_27(12).jpg");
    imwrite(outfile, test12);
